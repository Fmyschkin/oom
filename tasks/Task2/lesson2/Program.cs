...
namespace lesson2
{
	class MainClass
	{
		public static void Main (string[] args)
		{
            ...
            var bookseller = new[]
            {
                new BookSeller("Alex Pirka", "pirka.alex@gmail.com", "040 3827741 "),
                new BookSeller("Martin Wöser", "wöser@hotmail.com", "0503827741"),
            };

            foreach (var s in bookseller)
            {
                Console.WriteLine("{0} {1} {2}", s.Name, s.Email, s.Telephon);
            }
        }
	}
}
